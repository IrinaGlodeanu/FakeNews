...
public aspect MultiSpec_1MonitorAspect implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	before (Iterator i) : HasNext_next(i) {
		MultiSpec_1RuntimeMonitor.HasNext_nextEvent(i);
	}
